              ...
              <label key={rating} className="flex items-center cursor-pointer group">
                <div className="relative">
                  <input
                    ...
                    className="peer sr-only"
                  />
                  <div className="w-5 h-5 border-2 border-gray-300 rounded-full peer-checked:border-blue-500 peer-checked:bg-blue-500 transition-all duration-200 flex items-center justify-center group-hover:border-gray-400">
                    <div className="w-2 h-2 bg-white rounded-full peer-checked:opacity-100 opacity-0 transition-opacity duration-200"></div>
                  </div>
                </div>
                <span className="ml-3 text-sm text-gray-700 flex items-center group-hover:text-gray-900 transition-colors duration-200">
